...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      // Navigation to dashboard will be handled by useEffect when isAuthenticated changes
    } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">Create your account and start tracking your environmental impact</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>Join thousands of users making a positive environmental impact</p>
        </div>
      </div>
    </div>
  )
